...
import StartStopActor1._
import StartStopActor2._
import PrintMyActorRefActor._

//#test-classes
class AkkaHierarchyExperimentsSpec(_system: ActorSystem)
  ...
  def this() = this(ActorSystem("AkkaHierarchyExperimentsSpec"))
